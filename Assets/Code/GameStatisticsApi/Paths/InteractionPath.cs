...
namespace GameStatisticsApi 
{
  ...
  public class InteractionPath : ApiPath
  {
#region Cache
    internal Dictionary<int,InteractionRowData> Cache { get ; } = new () ;
#endregion
...
#region POST
    public override IEnumerator Post( int[] ids, byte[] data ) { throw new NotImplementedException() ; }
#endregion
